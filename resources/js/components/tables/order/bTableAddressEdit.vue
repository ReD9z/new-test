...
<v-flex>
    ...
    <v-data-table :rows-per-page-items='[25, 35, 45, {text: "Все", value: -1}]' v-model="selected" select-all :pagination.sync="pagination" :headers="params.headers" :items="desserts" :loading="loading" class="elevation-1">
